                ...
                <div key={entry.id} className="bg-background border border-border rounded-2xl p-5 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <p className="font-black text-xl tracking-widest">{v?.plate ?? "—"}</p>
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    {NEXT_STATUS[entry.status] && (
                      <button
                        ...
                        className="bg-primary text-primary-foreground text-xs font-bold px-4 py-2 rounded-xl hover:opacity-90 whitespace-nowrap"
                      >
