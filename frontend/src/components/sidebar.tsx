...
import {
  LayoutDashboard, CalendarCheck, Users, List, Settings, LogOut, Gauge, Droplets, UserCog, MessageCircle, Wrench,
} from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { href: "/owner/services",         label: "Serviços",     icon: <Wrench size={16} />,           roles: ["owner"] },
